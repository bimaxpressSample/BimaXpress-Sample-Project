...
// import Enchance from "./EnhanceModal";

Modal.setAppElement("#root");

type EnhanceModalProps = {
    isOpen?: boolean;
    closeModal?: () => void;
    newCaseData?: any;
    status?: any;
...
const EnhanceModal = ({
    ...
    const [formdata, setData] = useState<any>({ file: [], amount: "", date: "" , claimNumber:"" });
    ...
    const uploadFile = async () => {
        ...
        try {
            ...
            //@ts-ignore
            const URLFORMCREATIONAUDITTRIAL = `/${enhanceApi[radiostatus]}?email=${user}&casenumber=${data.case}`;
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between py-4" style={{ backgroundColor: "grey", height: "40px", borderTopLeftRadius: "10px", borderTopRightRadius: "10px", zIndex: "4" }}>
                <div className="flex items-center ml-10">

                    <div className="mr-8 ">
                        <InputRadio
                            handleChange={(e) => setRadioStatus(e?.target?.value)}
                            name="approved"
                            value="approved"
                            radioLabel="Approved"
                            fieldName={radiostatus || ""}
                        />
                    </div>
