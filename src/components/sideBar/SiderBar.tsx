...
const sideBarMenu = [
  ...
  },
  {
    name: 'Wallet',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-wallet2 mr-4 ml-2 md:ml-5 text-xl text-white" viewBox="0 0 16 16">
