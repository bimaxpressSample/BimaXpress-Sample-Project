...
const ProgessBar = ({ steps, prevStep, newCaseData }: ProgessBarProps) => {
  ...
  return (
    <>
   <div className="box1"style={{color:"orange",width: "130px",
  height: "30px",marginTop: '-30px'
 }}>Details of TPA
  ...
  <div className="box1"style={{color:"orange",width: "130px",
  height: "30px",
 marginLeft:"333px",marginTop: "-30px"}}>Patient Details
 </div>

<div className="box1"style={{color:"orange",width: "230px",
  height: "30px",
 marginLeft:"620px",marginTop: "-30px"}}>Doctor's And Diagnosis Details
 </div>
<div className="box1"style={{color:"orange",width: "140px",
  height: "30px",
 marginLeft:"970px",marginTop: "-30px"}}>Admission Details
  </div>
