...
const SentMail = ({ newCaseData = {}, action = '' }: ComposeModalProps) => {
  ...
  const [additionalDetailsRender, setAdditionDetailsRender] = useState(true);
  ...
  const [additionalCharges, setadditionalCharges] = useState<any>({
    patientDetails: {
      ...
      diabetes_month: diabetes_month,
      diabetes_year: diabetes_year,
      HeartDiseaseMonth: HeartDiseaseMonth,
      HeartDiseaseYear: HeartDiseaseYear,
      HypertensionMonth: HypertensionMonth,
      HypertensionYear: HypertensionYear,
      HyperlipidemiasMonth: HyperlipidemiasMonth,
      HyperlipidemiasYear: HyperlipidemiasYear,
      OsteoarthritisMonth: OsteoarthritisMonth,
      OsteoarthritisYear: OsteoarthritisYear,
      AsthmaOrCOPDOrBronchitisMonth: AsthmaOrCOPDOrBronchitisMonth,
      AsthmaOrCOPDOrBronchitisYear: AsthmaOrCOPDOrBronchitisYear,
      CancerMonth: CancerMonth,
      CancerYear: CancerYear,
      AlcoholOrDrugAbuseMonth: AlcoholOrDrugAbuseMonth,
      AlcoholOrDrugAbuseYear: AlcoholOrDrugAbuseYear,
    ...
    hospitalDetails: {
      ...
      ConsultationAndPhysicianCharges: ConsultationAndPhysicianCharges,
      professional_fees: professional_fees,
      AnaethetistCharges: AnaethetistCharges,
      MedicinesAndCostOfImplant: MedicinesAndCostOfImplant,
      Consumables: Consumables,
      OtherHospitalIfAny: OtherHospitalIfAny,
    },
  });

  // setadditionalCharges((pre: any) => ({
  //   ...pre,
  ...
  // ) => {
  //   const { name, value } = e?.target;
  //   setadditionalData((pre) => ({ ...pre, [name]: value }));
  // };
  ...
  useEffect(() => {
    ...
    //   newCaseData.patient_details.Insurance_Company === 'Star_Health_Insurance'
    // ) {
    ...
    >
      ...
      {/* <div className='mt-6'>
        <Input
          ...
          name='expenses'
          value={additionalData?.expenses || ''}
          type='number'
          style={inputStyle}
          placeHolder='Please specify the amount'
        />
      </div> */}
      {console.log(additionalCharges?.hospitalDetails?.Room_No)}
      {chargesListData &&
