...
const UpgradePlan = ({ setCurrentPlan, currentPlan }: UpgradePlanProps) => {
    ...
    const toggleBuyModal = (planType :any , planAmount:any , totalClaims:any , planId:any , duration:any) => {
                                        ...
                                        return(
                                            <div key={index} className="w-full overflow-hidden transition-colors duration-200 transform rounded-lg md:mx-5 md:w-96 bg-gray-50 dark:bg-gray-700">
                                                ...
                                                <div className="px-6 py-4">
                                                    ...
                                                    <button onClick={() => toggleBuyModal(plan?.name , plan?.price , plan?.claims , plan?.planId , plan?.duration)} className="w-full px-4 py-2 mt-10 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">
                                                        Choose {plan?.name}
                                                    </button>
                                                </div>
                                            </div>
